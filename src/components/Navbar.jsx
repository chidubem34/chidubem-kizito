                        ...
                        <div className="flex items-center justify-between sm:items-stretch sm:justify-start">
                            ...
                            <div className="hidden sm:ml-6 sm:block">
                                <div className="flex space-x-4">
                                    <Link to={"/chidubem-kizito/"} className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</Link>
                                    <Link to={"/chidubem-kizito/about"} className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">About</Link>
                                    <Link to={"/chidubem-kizito/projects"} className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Projects</Link>
                                </div>
                            </div>
                        </div>
                    </div>
